...
const MidiClient = midi.MidiClient;
...
pub const LaunchpadClient = struct {
    ...
    pub fn setColor(self: LaunchpadClient, note: Note, color: Color, op: Color.BackBufferOperation) !void {
...
pub const Note = struct {
    ...
    pub fn buttonType(self: Note) ButtonType {
